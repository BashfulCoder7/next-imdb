      ...
      <div className="max-w-2xl mx-auto p-2 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 dark:text-gray-300 flex flex-col gap-6">
            <p>
              Welcome to IMDB Clone! This app is designed to provide users
              with a comprehensive database of movies, TV shows, and
              entertainment content. Our goal is to offer a seamless and
              enjoyable experience for movie enthusiasts and casual viewers
              alike.
            </p>
